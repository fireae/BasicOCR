...
static PAGE_RES* RecognitionPass1WithMonitor(BLOCK_LIST* block_list, ETEXT_DESC *monitor);
static PAGE_RES* RecognitionPass2WithMonitor(BLOCK_LIST* block_list, PAGE_RES* pass1_result, ETEXT_DESC *monitor);
