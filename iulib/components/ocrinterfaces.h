...
namespace ocropus {
    ...
    struct ICleanupGray : virtual IComponent {
        ...
        virtual void cleanup_gray(colib::bytearray &out,colib::bytearray &in) { throw Unimplemented(); }
    };
    ...
    struct IBinarize : virtual IComponent {
        ...
        /// implementation.
        virtual void binarize(colib::bytearray &out,colib::bytearray &in)  { throw Unimplemented(); }
        ...
        /// image).
        virtual void binarize(colib::bytearray &out,colib::bytearray &gray,colib::bytearray &in) {
            binarize(out,in);
            gray = in;
        }
    };
