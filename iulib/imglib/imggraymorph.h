...
namespace iulib {
    ...
    void minshift(colib::bytearray &image, colib::bytearray &image2, int dx, int dy, colib::byte offset=0);
    void maxshift(colib::bytearray &image, colib::bytearray &image2, int dx, int dy, colib::byte offset=0);
