...
namespace ocropus {
    ...
    void WhitespaceCuts::find_hspaces(rectarray &hspaces,
        ...
        for(int i=0; i<wlen; i++){
            ...
            if( (colib::getmax(top_neighbors, bottom_neighbors) >= maxthreshold) &&
                (colib::getmin(top_neighbors, bottom_neighbors) >= minthreshold) ){
    ...
    void WhitespaceCuts::filter_hspaces(rectarray &hspaces,
        ...
        for(int i=0; i<hlen; i++){
            rectangle temp = hcutsheap.extractgetmax();
