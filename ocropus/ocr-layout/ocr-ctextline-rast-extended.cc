...
namespace ocropus {
    ...
    void CTextlineRAST4line::TLState4line::update(CTextlineRAST4line &line,
        ...
        for(int i = 0;i<candidates.length();i++) {
            ...
            if(b.y1<y.lo) {
                ...
                interval minq = colib::getmin(q_baseline,q_xline);
    ...
    void CTextlineRASTExtended::pushResult(CState &result){
        ...
        if(extend){
            ...
            new_start = colib::getmax(new_start,temp.x0-min_gap);
            new_end = colib::getmin(new_end,temp.x1+min_gap);
