...
namespace ocropus {
    void init_ocropus_components() {
        ...
        //Gary component_register("SimpleGrouper",make_SimpleGrouper);
        //Gary component_register("StandardGrouper",make_StandardGrouper);
        ...
        //Gary component_register("simple-grouper",make_SimpleGrouper);
        //Gary component_register("standard-grouper",make_StandardGrouper);
